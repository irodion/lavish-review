...
**Next (PRD'd):** Deck Mode — the map+stage served presentation, hunk-anchored evidence (`review-analysis/0.3`), claim-scoped questions, judgment-color restyle with a light theme (ADR-0014, ADR-0015). *(The structural lint rules from this PRD have shipped — see implemented scope above.)*
