...
**Next (PRD'd):** Deck Mode — the map+stage served presentation, claim-scoped questions, judgment-color restyle with a light theme (ADR-0014, ADR-0015). *(Two foundations from this PRD have shipped ahead of the presentation layer — see implemented scope above: the structural lint rules, and the **Hunk Anchorer** with `review-analysis/0.3` hunk-anchored evidence.)*
